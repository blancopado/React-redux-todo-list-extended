...
describe('VisibilityFilter action creator', () => {
  ...
  it('should create an action to change the Visibility Filter to show all todos', () => {
    const visibilityFilterExpectedAction= { type: constants.SET_VISIBILITY_FILTER, filter: constants.SHOW_ALL };
  ...
  it('should create an action to change the Visibility Filter to show completed todos', () => {
    const visibilityFilterExpectedAction= { type: constants.SET_VISIBILITY_FILTER, filter: constants.SHOW_COMPLETED };
  ...
  it('should create an action to change the Visibility Filter to show active todos', () => {
    const visibilityFilterExpectedAction= { type: constants.SET_VISIBILITY_FILTER, filter: constants.SHOW_ACTIVE };
